...
points(log(abc$c,10), log(abc$e,10), bg=PAL[unique(abc$type)],
  pch=20+i, col="darkgray", cex=ifelse(i==1, 1.7, 1.2), lwd=1.5)
title(
...
legend("center", pt.bg=PAL, pch=c(21:25), legend=LABELS, col="darkgray", bty='n', pt.cex=c(1.8, 1.2, 1.2, 1.2, 1.2), cex=1.4)
