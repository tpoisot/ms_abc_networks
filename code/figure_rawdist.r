...
pdf("../figures/distances.pdf", height=8, width=13)
par(las=1, xaxs="i", yaxs="i", cex=2, mar=c(4.1, 4.0, 0.5, 0.3), mgp=c(2.1,0.8,0))

plot(NA, xlim=c(0,6), ylim=c(0, 0.5), axes=F, bty='n', xlab="", ylab="", main="")
grid(nx=NA, ny=5, lty=1, col="lightgrey", lwd=2.5)
...
axis(2, lwd=0, lwd.ticks=1, col.ticks="darkgray", at=c(0, 0.5))
